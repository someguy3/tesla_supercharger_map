 ...
 * @constructor
 */
redshiftsoft.Routing = function () {
    this.routeList = [];
    this.directionsService = new google.maps.DirectionsService();
    $("#route-panel-close-trigger").click(jQuery.proxy(this.closeRoutePanel, this));
};

redshiftsoft.Routing.prototype.handleAddRouteEvent = function (event, eventData) {
    this.handleAddRoute(eventData.latLng, eventData.googleMap);
};


redshiftsoft.Routing.prototype.handleAddRoute = function (latLng, googleMap) {
...
redshiftsoft.Routing.prototype.calcWayPoints = function (locationList) {
    var wayPoints = [];
...
redshiftsoft.Routing.prototype.handleRouteResponse = function (response, status) {
...
redshiftsoft.Routing.prototype.initializeDirectionRenderer = function (googleMap) {
...
redshiftsoft.Routing.prototype.closeRoutePanel = function (event) {
...
redshiftsoft.Routing.prototype.showRoutePanel = function () {
    var mapMainContentRow = $("#map-row-main-content");
    var routeDiv = mapMainContentRow.children().eq(0);
    var mapDiv = mapMainContentRow.children().eq(1);
